...
if (window.top != window) {
	...
	window.open('https://gamebox.heheda.top/play/', '_self');
	...
	if (urldata.indexOf('index') > -1) {
		...
		document.getElementById('name').innerHTML = "侧载游戏功能demo";
		// 修改title
		// document.title = gameInfo.n + gnm + ' - ' + '红白机游戏盒';
		document.title = "侧载游戏功能demo - 在线游戏盒";
		// window.gameName = gameInfo.n + gnm;
		window.gameName = "侧载游戏功能demo";
		// 联机服务
